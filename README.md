...
```sh
  cd my-folder
  git clone https://github.com/SanaTameem/blog-app.git
```
...
Feel free to check the [issues page](https://github.com/SanaTameem/blog-app/issues).
...
This project is [MIT](https://github.com/SanaTameem/blog-app/blob/feature/validations-model-specs/MIT.md) licensed.
